...
const sendOTP = async () => {
  ...
  try {
    ...
    await axios.post(`http://172.21.96.1:8000/send-otp/${accountIdz}`);
...
const submitImage = async () => {
  ...
  try {
    ...
    await axios.post(`http://172.21.96.1:8000/update_account/${accountId}`, formData, {
      headers: {
...
const updateProfile = () => {
  ...
  try {
    ...
    axios.post(`http://172.21.96.1:8000/update_account/${accountIdz}`, formData)
      .then(response => {
...
const fetchOTPData = async () => {
  try {
    const response = await axios.get('http://172.21.96.1:8000/get_otp_json');
