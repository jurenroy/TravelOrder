...
const sendOTP = async () => {
  ...
  try {
    ...
    await axios.post(`http://192.168.239.35:8000/send-otp/${accountIdz}`);
...
const submitImage = async () => {
  ...
  try {
    ...
    await axios.post(`http://192.168.239.35:8000/update_account/${accountId}`, formData, {
      headers: {
...
const updateProfile = () => {
  ...
  try {
    ...
    axios.post(`http://192.168.239.35:8000/update_account/${accountIdz}`, formData)
      .then(response => {
