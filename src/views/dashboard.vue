<template>
  <div>
    <div
      ...
      v-if="isEdits && isRegistrationClicked"
    >
      <editss></editss>
    </div>
    <div
      style="flex-direction: column; justify-content: center"
      v-if="isRegistrationClicked && !isEdits"
    >
      <registrationform></registrationform>
    </div>
    <div
      style="flex-direction: column; justify-content: center"
      v-if="employeelis && !isEdits"
    >
              ...
              <div v-if="!isRegistrationClicked">
                ...
                >
                  ...
                  <div>
                    ...
                    <button
                      v-show="
                        !isVisible && acc.type_id == 1 && acc.name_id == 76
                      "
                      class="reg"
                    ...
                    <button
                      v-show="!isVisible && acc.type_id == 1"
                      class="emplo"
                      @click="employeelst"
                    >
                      {{ "Employee List" }}
