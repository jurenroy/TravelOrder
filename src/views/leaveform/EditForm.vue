<template>
    ...
    <div class="form-container">
      <h1 style="text-align: center; margin-top: -10px;">Leave Form Edit</h1>
      <form @submit.prevent="submitForm">
        ...
        <!-- Sick Leave Details -->
        <div v-if="isSickLeave" class="form-row">
        ...
        <div class="form-row">
          <div class="form-group">
            <label for="Inclusive Date">Inclusive Date  {{ isfromDB ? "("+weekdaysCountWithSuffix+")" : ''}}</label>    
        ...
        <!-- Submit Button -->
         <div style="display: flex; justify-content: space-around;">
          <button type="button" :disabled="formDisable == true" @click="cancelEdit()">Cancel</button>
