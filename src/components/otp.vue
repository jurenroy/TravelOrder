<template>
  ...
  >
    ...
    <div v-if="!OTPsuccesful && !OTPsent && ANSAK" class="unsuccesfullyotp">
      <a class="succesfullyotp1"> OTP loaded unsuccessfully </a>
    </div>
    <div v-if="OTPsent" style="border: 2px solid black; border-radius: 10px">
      ...
      >
        ...
        <div v-if="expired" class="expireds">
          <a class="verifieds1"> OTP Expired </a>
        </div>

        <div v-if="wrongOTPs" class="expireds">
          <a class="verifieds1"> Incorrect Input OTP </a>
        </div>
        ...
        <button class="verifyotps" v-if="expire" @click="sendOTP">
          Resend OTP
        </button>
      </div>
    </div>
