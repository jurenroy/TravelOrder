...
const setAccount = async () => {
  try {
    const response = await axios.post(`http://172.21.96.1:8000/update_employee/${setEmployee.value}`);
...
const fetchEmployee = async () => {
  try {
    const response = await axios.get('http://172.21.96.1:8000/get_employees_json');
